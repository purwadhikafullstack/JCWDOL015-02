...
export class PickupDeliveryRequestController {
  async createPickupDeliveryRequest(
    req: Request,
    res: Response,
  ): Promise<Response> {
    const {
    ...
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error creating Pickup Delivery Request',
        });
    }
  }

  async getAllPickupDeliveryRequests(
    req: Request,
    res: Response,
  ): Promise<Response> {
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error fetching Pickup Delivery Requests',
        });
    }
  }

  async getPickupDeliveryRequestById(
    req: Request,
    res: Response,
  ): Promise<Response> {
    const { id } = req.params;
    ...
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error fetching Pickup Delivery Request',
        });
    }
  }
  async getPickupDeliveryRequestWorkerId(
    req: Request,
    res: Response,
  ): Promise<Response> {
    const { id } = req.params;
  ...
  async updatePickupDeliveryRequest(
    req: Request,
    res: Response,
  ): Promise<Response> {
    const { id } = req.params;
    ...
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error updating Pickup Delivery Request',
        });
    }
  }

  async updatePickupDeliveryRequestStatus(
    req: Request,
    res: Response,
  ): Promise<Response> {
    ...
    if (!id || !status) {
      return res
        .status(400)
        .json({ status: 'error', message: 'ID and status are required' });
    }
    ...
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error updating Pickup Delivery Request status',
        });
    }
  }

  async deletePickupDeliveryRequest(
    req: Request,
    res: Response,
  ): Promise<Response> {
    const { id } = req.params;
    ...
    try {
      ...
      return res
        ...
        .json({
          status: 'error',
          message: 'Error deleting Pickup Delivery Request',
        });
    }
  }
}
