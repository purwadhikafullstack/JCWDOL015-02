  ...
  return (
    <section className="relative w-full h-[80vh] sm:h-[70vh] md:h-[80vh] lg:h-[80vh] overflow-hidden flex justify-center items-center">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white z-10">
        ...
        <button className="mt-11 hover:bg-black hover:text-beigeCustom bg-beigeCustom text-black py-2 px-4 rounded-full transition duration-200">
...
// import { useState, useEffect } from 'react';
// import Image from 'next/image';
// import carousel from '@/data/assetsImage.json';
