  ...
  return (
    <div className="w-full flex flex-col  justify-start items-center py-5 bg-beigeCustom">
      ...
      <div className="w-full flex flex-col justify-center items-center text-center text-black">
        <h1
          className="text-2xl font-bold md:text-4xl tracking-wider cursor-pointer duration-300 flex justify-center items-center gap-2"
        ...
        <dialog id="my_modal_username" className="modal">
          <div className="modal-box flex justify-center items-center gap-3 bg-[#0000006b] mx-2">
            <Formik
              ...
              onSubmit={(values: IUpdateUsername, { resetForm }) =>
        ...
        <p
          onClick={() => openModal('modal_update_email')}
          className="text-sm font-bold md:text-base tracking-wide mt-2 cursor-pointer"
        >
          {user.email}
        </p>
